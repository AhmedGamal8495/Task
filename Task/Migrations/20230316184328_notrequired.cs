        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NWC_Default_Slice_Values_Name = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    ...
                    NWC_Default_Slice_Values_Reasons = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NWC_Rreal_Estate_Types_Name = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false),
                    NWC_Rreal_Estate_Types_Reasons = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NWC_Subscriber_File_Name = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
                    NWC_Subscriber_File_City = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    NWC_Subscriber_File_Area = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    NWC_Subscriber_File_Mobile = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    NWC_Subscriber_File_Reasons = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NWC_Subscription_File_No = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: false),
                    NWC_Subscription_File_Subscriber_Code = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: false),
                    NWC_Subscription_File_Rreal_Estate_Types_Code = table.Column<string>(type: "char(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: false),
                    NWC_Subscription_File_Unit_No = table.Column<int>(type: "int", nullable: false),
                    NWC_Subscription_File_Is_There_Sanitation = table.Column<bool>(name: "NWC_Subscription_File_Is_ There_Sanitation", type: "bit", nullable: false),
                    NWC_Subscription_File_Last_Reading_Meter = table.Column<int>(type: "int", nullable: true),
                    NWC_Subscription_File_Reasons = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NWC_Subscription_File", x => x.NWC_Subscription_File_No);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NWC_Invoices_Rreal_Estate_Types = table.Column<string>(type: "char(1)", unicode: false, fixedLength: true, maxLength: 1, nullable: false),
                    NWC_Invoices_Subscription_No = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: false),
                    NWC_Invoices_Subscriber_No = table.Column<string>(type: "char(10)", unicode: false, fixedLength: true, maxLength: 10, nullable: false),
                    ...
                    NWC_Invoices_Is_There_Sanitation = table.Column<bool>(name: "NWC_Invoices_Is_ There_Sanitation", type: "bit", nullable: false),
                    ...
                    NWC_Invoices_Total_Reasons = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NWC_Invoices", x => x.NWC_Invoices_No);
                    table.ForeignKey(
                        name: "FK_NWC_Invoices_NWC_Rreal_Estate_Types",
                        column: x => x.NWC_Invoices_Rreal_Estate_Types,
                        principalTable: "NWC_Rreal_Estate_Types",
                        principalColumn: "NWC_Rreal_Estate_Types_Code");
                    table.ForeignKey(
                        name: "FK_NWC_Invoices_NWC_Subscriber_File",
                        column: x => x.NWC_Invoices_Subscriber_No,
                        principalTable: "NWC_Subscriber_File",
                        principalColumn: "NWC_Subscriber_File_Id");
                    table.ForeignKey(
                        name: "FK_NWC_Invoices_NWC_Subscription_File",
                        column: x => x.NWC_Invoices_Subscription_No,
                        principalTable: "NWC_Subscription_File",
                        principalColumn: "NWC_Subscription_File_No");
                });
